#ifndef NOKIA_IP_VALIDATOR
#define NOKIA_IP_VALIDATOR
...
public:
     ...
     */
    NokiaIPValidator(const NokiaIPValidator& rhs) = delete;
    NokiaIPValidator(NokiaIPValidator&& rhs) = delete;
    NokiaIPValidator& operator=(const NokiaIPValidator& rhs) = delete;
    NokiaIPValidator& operator=(NokiaIPValidator&& rhs) = delete;
